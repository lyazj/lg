...
void GLExampleApplication::Init()
{
  ...
  glDisable(GL_FRAMEBUFFER_SRGB);  // We designed the colors before this default...
  ...
  lighting.liPos = { 0.0f, 0.0f, 4.0f, 1.0f };  // m
  lighting.liColor = vec4(1.0f);
  lighting.liDist = 1.0f;
  lighting.liAmb = 0.3f;
